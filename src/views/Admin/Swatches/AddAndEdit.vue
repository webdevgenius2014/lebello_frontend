    ...
    <div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-5">
            ...
            <div class="col-span-4">
                    ...
                    <Accordion open="false" header="Materials Template">
                        <div class="mt-2 px-6 flex h-auto ">
                            ...
                            <div class="w-4/6 m-auto ">
                                ...
                                <!-- <p>Selected Options: {{ isChecked }}</p> -->
                            </div>
                        </div>
                    </Accordion>
                </div>
             ...
             <ImageUpload2 @file-selected="handleFeaturedImg" :accepted-formats="['jpg', 'jpeg', 'png', 'pdf', 'doc', 'docx']"/>
                    ...
                    <Accordion open="false" header="Description">
                        <div class="mt-2 px-6 flex h-auto">
                            ...
                            <div class="w-4/6">
                                ...
                                <p class="text-sm text-gray-600 my-2"> The material term id. This is generated from material
